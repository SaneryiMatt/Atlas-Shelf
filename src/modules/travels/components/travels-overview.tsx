    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">卡片布局适合浏览地点、旅行日期、坐标，支持按更新时间和评分排序</p>
        </div>
              ...
              {items.map((trip) => (
                ...
                >
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Badge variant={trip.stage === "已到访" ? "outline" : "success"} className="text-xs">{trip.stage}</Badge>
                  </div>
